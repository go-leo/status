...
type HttpBody struct {
	...
	Error *HttpBody_Error `protobuf:"bytes,1,opt,name=error,proto3" json:"error,omitempty"`
}
...
func (x *HttpBody) GetError() *HttpBody_Error {
	if x != nil {
		return x.Error
	}
	return nil
...
func (x *HttpBody_Error) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*HttpBody_Error) ProtoMessage() {}

func (x *HttpBody_Error) ProtoReflect() protoreflect.Message {
	mi := &file_leo_status_http_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use HttpBody_Error.ProtoReflect.Descriptor instead.
func (*HttpBody_Error) Descriptor() ([]byte, []int) {
	return file_leo_status_http_proto_rawDescGZIP(), []int{0, 0}
}

func (x *HttpBody_Error) GetIdentifier() string {
	if x != nil {
		return x.Identifier
	}
	return ""
...
func (x *HttpBody_Error) GetRpcStatus() code.Code {
	if x != nil {
		return x.RpcStatus
	}
	return code.Code(0)
...
func (x *HttpBody_Error) GetHttpStatus() int32 {
	if x != nil {
		return x.HttpStatus
	}
	return 0
...
func (x *HttpBody_Error) GetMessage() string {
	if x != nil {
		return x.Message
	}
	return ""
...
func (x *HttpBody_Error) GetDetails() []*anypb.Any {
	if x != nil {
		return x.Details
	}
	return nil
...
var file_leo_status_http_proto_rawDesc = []byte{
	...
	,
	...
	0x79, 0x52, 0x07, 0x64, 0x65, 0x74, 0x61, 0x69, 0x6c, 0x73, 0x42, 0x32, 0x5a, 0x30, 0x67, 0x69,
	0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f, 0x6d, 0x2f, 0x67, 0x6f, 0x2d, 0x6c, 0x65, 0x6f, 0x2f,
	0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x2f, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x6c, 0x65, 0x6f,
...
var file_leo_status_http_proto_goTypes = []any{
	(*HttpBody)(nil),       // 0: leo.status.HttpBody
	(*HttpBody_Error)(nil), // 1: leo.status.HttpBody.Error
	(code.Code)(0),         // 2: google.rpc.Code
	(*anypb.Any)(nil),      // 3: google.protobuf.Any
}
var file_leo_status_http_proto_depIdxs = []int32{
	1, // 0: leo.status.HttpBody.error:type_name -> leo.status.HttpBody.Error
	2, // 1: leo.status.HttpBody.Error.rpc_status:type_name -> google.rpc.Code
	3, // 2: leo.status.HttpBody.Error.details:type_name -> google.protobuf.Any
