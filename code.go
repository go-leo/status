...
func AlreadyExists(opts ...Option) Status {
	return withOption(newStatus(codes.AlreadyExists), opts...)
}
...
func PermissionDenied(opts ...Option) Status {
	return withOption(newStatus(codes.PermissionDenied), opts...)
}
...
func ResourceExhausted(opts ...Option) Status {
	return withOption(newStatus(codes.ResourceExhausted), opts...)
}
...
func FailedPrecondition(opts ...Option) Status {
	return withOption(newStatus(codes.FailedPrecondition), opts...)
}
...
func Unimplemented(opts ...Option) Status {
	return withOption(newStatus(codes.Unimplemented), opts...)
}
...
func Unauthenticated(opts ...Option) Status {
	return withOption(newStatus(codes.Unauthenticated), opts...)
}
