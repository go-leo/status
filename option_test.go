...
func TestErrorInfo(t *testing.T) {
	...
	st := InvalidArgument(ErrorInfo(reason, domain, metadata))
...
func TestRetryInfo(t *testing.T) {
	...
	st := Unknown(RetryInfo(retryDelay))
...
func TestDebugInfo(t *testing.T) {
	...
	detail := "user exists"
	st := AlreadyExists(DebugInfo(stackEntries, detail))
...
func TestQuotaFailure(t *testing.T) {
	...
	st := ResourceExhausted(QuotaFailure(violations))
...
func TestPreconditionFailure(t *testing.T) {
	...
	st := FailedPrecondition(PreconditionFailure(violations))
...
func TestBadRequest(t *testing.T) {
	...
	st := InvalidArgument(BadRequest(violations))
...
func TestRequestInfo(t *testing.T) {
	requestId := ""
	servingData := ""
	st := PermissionDenied(RequestInfo(requestId, servingData))
...
func TestResourceInfo(t *testing.T) {
	...
	st := Aborted(ResourceInfo(resourceType, resourceName, owner, description))
...
func TestLocalizedMessage(t *testing.T) {
	locale := "locale"
	message := "message"
	st := DataLoss(LocalizedMessage(locale, message))
