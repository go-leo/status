...
// Errors
// Errors_OK status.example.error.OK OK
...
// Errors_DownloadCancelled status.example.error.DownloadCancelled DownloadCancelled
...
// Errors_RequestGoogleFailed status.example.error.RequestGoogleFailed RequestGoogleFailed
...
// Errors_InvalidPassword status.example.error.InvalidPassword InvalidPassword
...
// Errors_ResourceExpired status.example.error.ResourceExpired ResourceExpired
...
// Errors_UserNotFound status.example.error.UserNotFound UserNotFound
...
// Errors_UserAlreadyExists status.example.error.UserAlreadyExists UserAlreadyExists
...
// Errors_DeleteUserPermissionDenied status.example.error.DeleteUserPermissionDenied DeleteUserPermissionDenied
...
// Errors_TokenExpired status.example.error.TokenExpired TokenExpired
...
// Errors_HDD_FULL status.example.error.HDD_FULL HDD_FULL
...
// Errors_UserDeleted status.example.error.UserDeleted UserDeleted
...
// Errors_UserCreateFailed status.example.error.UserCreateFailed UserCreateFailed
...
// Errors_VideoOutOfRange status.example.error.VideoOutOfRange VideoOutOfRange
...
// Errors_MethodNotImplemented status.example.error.MethodNotImplemented MethodNotImplemented
...
// Errors_RedisCrash status.example.error.RedisCrash RedisCrash
...
// Errors_RequestRejected status.example.error.RequestRejected RequestRejected
...
// Errors_MysqlDataLoss status.example.error.MysqlDataLoss MysqlDataLoss
...
// Errors_FileDownloadFailed status.example.error.FileDownloadFailed FileDownloadFailed
...
// Errors_FileUploadFailed status.example.error.FileUploadFailed FileUploadFailed
